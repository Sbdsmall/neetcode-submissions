class DynamicArray {
    ...
    constructor(capacity) {
        ...
        console.log('array contents: ', this.useDArray)
    }
    ...
    resize() {
        ...
        console.log('useDArray Length: ', this.useDArray.length)
        console.log('tempArray Length: ', tempArray.length)
        // tempArray.concat(this.useDArray);
        for(let i = 0; i < this.useDArray.length; i++) {
            tempArray[i] = this.useDArray[i];
        }
        this.useDArray = tempArray;

        console.log('useDArray: ', this.useDArray)
